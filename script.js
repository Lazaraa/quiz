...
let timer_display = document.getElementById('time')
let timer
let timeLeft
...
start_button.addEventListener('click', function() {
    ...
    timer = setInterval(function() {
        ...
        if (timeLeft <= 0) {
            ...
            container_start_h3.innerHTML = `<h3>Time's up! You answered ${correct_answers_given} correct answers out of ${total_answers_given}.</h3>`
        }
    }, 1000)
